...
BrokenLinkChecker.prototype.getWorkingDirectory = function getWorkingDirectory() {
  return this.workingDirectory;
};

BrokenLinkChecker.prototype.getStorageFile = function getStorageFile() {
  return this.storageFile;
};

BrokenLinkChecker.prototype.getStorageFilename = function getStorageFilename() {
...
BrokenLinkChecker.prototype.getJSONStorage = function getJSONStorage(refresh) {
...
BrokenLinkChecker.prototype.persistJSONStorage = function persistJSONStorage() {
  var destFile = this.getStorageFilename();

  jsonfile.writeFileSync(destFile, this._jsonStorage);
};

BrokenLinkChecker.prototype.setup = function setup() {
  ...
  if (!fs.existsSync(destFile)) {
    ...
    console.warn('!! The storage file '+destFile.yellow.inverse+' already exists and will not be overwritten.\n   If you need it, you can run this command with the '+'reset'.inverse+' argument.');
  }
...
BrokenLinkChecker.prototype.clean = function clean() {
...
BrokenLinkChecker.prototype.addLinkSchema = function addLinkSchema(jsonSchema) {
